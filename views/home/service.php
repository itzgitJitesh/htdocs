        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-4 col-md-4 col-12">
                    <div class="card">
                        <img class="card-img-top" src="./images/sampl.jpg" height="250px" alt="Card image">
                        <div class="card-body">
                ...
                <div class="col-lg-4 col-md-4 col-12">
                    <div class="card">
                        <img class="card-img-top" src="./images/samp.jpg" height="250px" alt="Card image">
                        <div class="card-body">
                ...
                <div class="col-lg-4 col-md-4 col-12">
                    <div class="card">
                        <img class="card-img-top" src="./images/samp.jpg" height="275px" alt="Card image">
                        <div class="card-body">
